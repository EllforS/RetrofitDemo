...
public class MainActivity extends BaseActivity implements GirlContract.View
{
    ...
    @Inject
    GirlPresenterImpl girlPresenter;    //注意这里不能使用 Private 否则不能编译通过
    ...
    public void showList(List<Girl> list)
    {
        ...
        for (Girl girl : list)
        {
            datas.add(new BaseRecyclerData(girl));
        }
        /* 显示获取到的List */
        MainRcvAdapter adapter = new MainRcvAdapter(this, datas);
    ...
    @Override
    public void showError(RxException e)
    {
